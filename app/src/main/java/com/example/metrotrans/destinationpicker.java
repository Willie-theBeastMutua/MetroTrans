...
public class destinationpicker extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!Places.isInitialized()) {
            ...
            Toast.makeText(destinationpicker.this, "-----initialize-----", Toast.LENGTH_LONG).show();
        }
        ...
        try {
                   ...
                   String latitude = String.valueOf( place.getLatLng().latitude);
                    ...
                    setbutton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Log.w("mylatitude", mylat);
                            Log.w("mylongitude", myLong);
            ...
            Toast.makeText(destinationpicker.this, e.toString(), Toast.LENGTH_LONG).show();
        }
